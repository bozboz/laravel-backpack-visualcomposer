<div class="row-template vc-left-text-right-imageset">
    <input type="hidden" class="content">


    <div class="float-left">
        <input class="left_title" placeholder="{{ trans('visualcomposer::templates.left-text-right-imageset.crud.left_title') }}">
        <textarea class="left_wysiwyg"></textarea>
    </div>

    <div class="float-right">
        <input class="right_imageset_url" rel="right_imageset" placeholder="{{ trans('visualcomposer::templates.left-text-right-imageset.crud.right_imageset_url') }}">
    </div>

    <div class="clearfix"></div>

    <label>
        {{ trans('visualcomposer::templates.left-text-right-imageset.crud.bg_color_container') }}
    ...
    <label>
        {{ trans('visualcomposer::templates.left-text-right-imageset.crud.text_color') }}
...
@push('crud_fields_styles')
    <style>
        .vc-left-text-right-imageset .cke_chrome {
            width: 100%;
        }
        .vc-left-text-right-imageset input {
            display: block;
            width: 100%;
            margin: 1rem 0;
        }
        .vc-left-text-right-imageset .float-right {
            width: 49%;
            float: right;
        }
        .vc-left-text-right-imageset .float-left {
            width: 49%;
            float: left;
        }
        .vc-left-text-right-imageset img {
            width: 100%;
            height: 450px;
            object-fit: contain;
        ...
        .vc-left-text-right-imageset img[src=""] {
            display: none;
        }
    </style>
@endpush
